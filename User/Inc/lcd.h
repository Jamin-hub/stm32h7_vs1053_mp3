...
#define	LCD_RST_ON  HAL_GPIO_WritePin(LCD_RST_GPIO_Port, LCD_RST_Pin, GPIO_PIN_SET)//LCD背光  PB15   
...
void LCD_WR_REG(volatile uint16_t reg);//写寄存器
