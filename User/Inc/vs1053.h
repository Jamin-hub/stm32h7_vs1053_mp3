...
/* VS10XX 控制信号 */
#define VS10XX_RST(x)   HAL_GPIO_WritePin(VS10XX_RST_GPIO_Port, VS10XX_RST_Pin,   (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define VS10XX_XCS(x)   HAL_GPIO_WritePin(VS10XX_XCS_GPIO_Port, VS10XX_XCS_Pin,   (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define VS10XX_XDCS(x)  HAL_GPIO_WritePin(VS10XX_XDCS_GPIO_Port, VS10XX_XDCS_Pin, (x) ? GPIO_PIN_SET : GPIO_PIN_RESET)
#define VS10XX_DQ       HAL_GPIO_ReadPin(VS10XX_DREQ_GPIO_Port, VS10XX_DREQ_Pin)
...
void spi_set_speed(uint32_t baudrate_prescaler);
